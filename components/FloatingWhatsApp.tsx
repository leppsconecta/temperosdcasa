...
export default function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-4 bg-white text-earth-800 text-sm font-medium py-2 px-4 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-earth-100">
        Fale conosco!
        {/* Triangle pointer */}
